...
parser.add_argument('--model_dir', '-wd', type=str, default='./checkpoint/best_model.pth')
...
if __name__ == '__main__':
    ...
    model_dir = os.path.join('./checkpoint/', args.weight_name)
    ...
    model = FEANet.FEANet(args.n_class)
    ...
    conf_total_matfile = os.path.join('./FEANet_coding/result/Pred_' + args.weight_name, 'conf_' + args.weight_name + '.mat')
    print('\n###########################################################################')
